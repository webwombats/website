const WeDo = () => (
  <div className="flex flex-wrap items-center border-b border-gray-900 py-24">
    <div className="w-full md:w-6/12 px-4 mr-auto ml-auto mt-32">
      <div className="justify-center flex flex-wrap relative">
        <div className="my-4 w-full lg:w-6/12 px-4">
          <a href="#/documentation/react/alerts">
          ...
          <a href="#/documentation/vue/alerts">
        ...
        <div className="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
          <a href="#/documentation/javascript/alerts">
          ...
          <a href="#/documentation/angular/alerts">
